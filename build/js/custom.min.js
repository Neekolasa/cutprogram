	...
	if (void 0 !== $.fn.daterangepicker) {
		...
		var a = {
			...
			ranges: {
				...
				"Ladsds7 Days": [moment().subtract(6, "days"), moment()],
...
function init_daterangepicker_right() {
	if (void 0 !== $.fn.daterangepicker) {
		...
		function e(e, a, t) {
			console.log(e.toISOString(), a.toISOString(), t), $("#reportrange_right span").html(e.format("DD/MM/YYYY") + " - " + a.format("DD/MM/YYYY"))
		}
		var a = {
			startDate: moment(),
			endDate: moment(),
		...
		$("#reportrange_right span").html(moment().format("DD/MM/YYYY") + " - " + moment().format("DD/MM/YYYY")), $("#reportrange_right").daterangepicker(a, e), $("#reportrange_right").on("show.daterangepicker", function() {
			//console.log("show event fired")
		}), $("#reportrange_right").on("hide.daterangepicker", function() {
			//console.log("hide event fired")
		}), $("#reportrange_right").on("apply.daterangepicker", function(e, a) {
			//console.log("Start Date: " + a.startDate.format("YYYY-MM-DD") + " to " + a.endDate.format("YYYY-MM-DD"))
	...
	if ("undefined" != typeof echarts) {
		...
		if ($("#echart_world_map").length) echarts.init(document.getElementById("echart_world_map"), e).setOption({
			title: {
				...
				subtext: "from United Nations, Total population, both sexes combined, as of 1 Julio (thousands)",
				x: "center",
				y: "top"
			},
			tooltip: {
